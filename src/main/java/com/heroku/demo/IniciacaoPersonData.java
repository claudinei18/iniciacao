...
public class IniciacaoPersonData {
    ...
    public static void main (String[] args) throws JSONException, UnknownHostException {
        ...
        File file = new File("/home/claudinei/Iniciacao/dbpedia/persondata_en.ttl");
...
//                putJsonElasticSearch(entidade);
    ...
    public static String getProperty(String line){
        try{
            ...
            String requiredString = rest[1].substring(rest[1].lastIndexOf("/") + 1, rest[1].indexOf(">"));
            String aux[] = requiredString.split("#");
            if(aux.length > 1){
                return aux[1];
            }
            /*String[] half = rest[1].split(">");
    ...
    public static boolean putUsingApi(JSONObject object) throws UnknownHostException, JSONException {
        ...
        IndexResponse response = client.prepareIndex("persondata", object.getString("originName"))
