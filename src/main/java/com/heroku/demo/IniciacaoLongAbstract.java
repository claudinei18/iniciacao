...
public class IniciacaoLongAbstract {
...
//        File file = new File("/home/claudinei/Downloads/infobox_properties_en.ttl");
        File file = new File("/home/claudinei/Iniciacao/dbpedia/long_abstracts_en_example.txt");
...
//                    putUsingApi(entidade);
    ...
    public static String getSubject(String line){
        try{
            String[] rest = line.split("ontology/");
            String[] half = rest[1].split("> ");
    ...
    public static String getValue(String line){
        try {
            return line.substring(line.lastIndexOf("abstract> ") + 1, line.indexOf("@en ."));
        }catch (Exception e){
